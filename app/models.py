#!/usr/bin/env python
"""A module for defining the database models."""
from . import db
...
class Student(db.Model):
    """A class to represent a student in the database."""
...
class Teacher(db.Model):
    """A class to represent a teacher in the database."""
...
class Course(db.Model):
    """A class to represent a course in the database."""
...
class Enrollment(db.Model):
    """A class to represent an enrollment in the database."""
