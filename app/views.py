...
from .models import User, Teacher, Student, Course, Enrollment
from . import db, bcrypt, uploaded_files
...
@views.route('/courses/create', methods=['GET', 'POST'])
@login_required
def create_course():
    if current_user.role != 'teacher':
...
@views.route('/courses/enroll/<int:course_id>', methods=['POST'])
@login_required
...
@views.route('/courses/unenroll/<int:course_id>', methods=['POST'])
@login_required
...
@views.route('/courses/description/<int:course_id>')
@login_required
...
@views.route('/courses/delete/<int:course_id>', methods=['POST'])
@login_required
...
@views.route('/courses/edit/<int:course_id>', methods=['GET', 'POST'])
@login_required
...
@views.route('/courses/view/<int:course_id>')
@login_required
